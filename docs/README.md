...
**Live demo:** the site opens on `index.html`, a scrollable narrative that walks through
the whole argument. A link at the end (and `explorer.html` directly) opens the 4-tab
...
| File | What it is |
|------|------------|
| `index.html` | Main entry: scrollable narrative walking through the whole argument |
| `explorer.html` | 4-tab interactive explorer (hero shot, linked explorer, six-way overview, perplexity animation) |
